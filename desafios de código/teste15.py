...
class Categoria:
    ...
    def adicionar_venda(self, produto, quantidade, valor):
    ...
    def total_vendas(self):
        ...
        for venda in self.vendas:
            # Aqui, vamos somar o valor total de cada venda diretamente
            total += venda.valor  # Considerando que o valor já seja o valor total
        return total
...
def main():
    ...
    for i in range(2):
        ...
        for j in range(2): 
            ...
            categoria.adicionar_venda(produto.strip(), quantidade, valor)
